...
def main (message) : 
    if message.text.lower () == "браузер" : 
        ...
        ToastNotifier().show_toast("BOT","Запускаю Google Chrome",threaded=True, duration=3)
        click()
        os.system ('"C:\Program Files\Google\Chrome\Application\chrome.exe"')
    
    elif message.text.lower () == "spotify" :
        bot.send_message (message.chat.id ,"Запускаю Spotify",reply_markup=keyboard)
        ToastNotifier().show_toast("BOT","Запускаю Spotify" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT","Запускаю Visual Studio Code" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT" , "Запускаю GitHub Desktop" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT" , "Запускаю Visual Studio 2019" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT", "Запускаю Arduino IDE" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT" , "Запускаю Processing 13" , threaded=True, duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT" , "Запускаю qBittorrent" , threaded=True , duration=3)
        click()
        ...
        ToastNotifier().show_toast("BOT" , "Запускаю Krita Desktop" , threaded=True, duration=3)
        click()
