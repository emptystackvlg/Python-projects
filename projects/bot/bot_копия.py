...
bot = telebot.TeleBot('1192738735:AAHs0LACIuvpQCY37hYxycF3wZ8CsEdSpQw')
    ...
    def main ():
        ...
        def send_text(message):
            ...
            if message.text.lower() == "пока":
                ...
                bot.send_message(message.chat.id , "PyDownloader - это  программа для скачивания вмультимедиа с различных сайтов (к примеру Youtube , VK , Яндекс.Музыка)" + "\n" + "https://sourceforge.net/projects/pydownloader-from-youtube/")
            ...
            elif message.text.lower() == "официальный сайт":
        ...
        def wiki(message) :
            try:
                ...
                bot.send_message(message.chat.id , "Я старался :(")
